# tf-atom-apigateway-deployment-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-apigateway-deployment-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-apigateway-deployment-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS API Gateway Deployment - triggers API deployment.
...
| <a name="input_triggers"></a> [triggers](#input\_triggers) | Map of triggers that force a new deployment | `map(string)` | `{}` | no |
